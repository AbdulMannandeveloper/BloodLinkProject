...
function Post_Request() {
  ...
  const validate = () => {
    ...
    if (!formData.agreeLegalAction)
      newErrors.agreeLegalAction = "You must agree to the legal action clause";
    if (!formData.agreeEthicalRequest)
      newErrors.agreeEthicalRequest = "You must confirm ethical responsibility";
    setErrors(newErrors);
